...
# ---------------------------------------------------------------------------------------------------------
proyect=ca.projects.new(title:"Projecto de ejemplo alvarez",description:"Este es un proyecto de ejemplo nomás", duration:"2",is_payed:true,amount:0,vacancies:12, user_id:ca.id)
proyect.save

# proyect1=rd.projects.new(title:"Projecto de ejemplo delpiano ",description:"Este es un proyecto de ejemplo nomás con otra descripcion", duration:"2",is_payed:true,amount:2,vacancies:2, user_id:rd.id, status: 0)
# proyect1.save

proyect2=po.projects.new(title:"Projecto de ejemplo obras ",description:"Este es un proyecto de ejemplo nomás", duration:"4",is_payed:true,amount:21,vacancies:20, user_id:po.id, status: 1)
proyect2.save

proyect3=pe.projects.new(title:"Projecto de ejemplo electro ",description:"Este es un proyecto de ejemplo nomás", duration:"6",is_payed:true,amount:7,vacancies:9, user_id:pe.id)
proyect3.save

proyect4=pa.projects.new(title:"Projecto de ejemplo ambiental ",description:"Este es un proyecto de ejemplo nomás", duration:"7",is_payed:true,amount:90,vacancies:8, user_id:pa.id)
proyect4.save

proyect5=ca.projects.new(title:"Projecto de ejemplo claudio 2 ",description:"Este es un proyecto de ejemplo nomás", duration:"5",is_payed:true,amount:9,vacancies:7, user_id:ca.id)
proyect5.save
